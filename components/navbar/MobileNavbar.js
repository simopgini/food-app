      ...
      <ul className="py-6 pb-8 px-10 flex justify-between items-center text-sm">
        <li>
          <Link href="/" legacyBehavior>
            <button
              className={router.pathname == "/" ? "active" : "deactive"}
              onClick={handleClick}
            >
              {toggle ? (
                <HiHome className="h-6 w-6 mr-1 hover:text-green transition" />
              ) : (
                <HiOutlineHome className="h-6 w-6 mr-1 hover:text-green transition" />
              )}
            </button>
          </Link>
        </li>
        ...
        <li>
          <Link href="/search" legacyBehavior>
            ...
            >
              {toggle ? (
                <HiSearch className="h-6 w-6 mr-1 hover:text-green transition" />
              ) : (
                <HiOutlineSearch className="h-6 w-6 mr-1 hover:text-green transition" />
              )}
            </a>
          </Link>
        </li>
        ...
        <li>
          <Link href="/list" legacyBehavior>
            <a
              className={router.pathname == "/list" ? "active" : "deactive"}
              onClick={handleClick}
            >
              {toggle ? (
                <HiClipboardList className="h-6 w-6 mr-1 hover:text-green transition" />
              ) : (
                <HiOutlineClipboardList className="h-6 w-6 mr-1 hover:text-green transition" />
              )}
            </a>
          </Link>
        </li>
        ...
        <li>
          <Link href="/profile" legacyBehavior>
            ...
            >
              {toggle ? (
                <HiUser className="h-6 w-6 mr-1 hover:text-green transition" />
              ) : (
                <HiOutlineUser className="h-6 w-6 mr-1 hover:text-green transition" />
              )}
            </a>
          </Link>
        </li>
