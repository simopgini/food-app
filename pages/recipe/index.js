...
const VegetarianRecipe = ({vegetarianRecipeCard}) => {
  
  {
    const [showIngredients, setShowIngredients] = useState();
  
    const [vegRecipeCard, setVegRecipeCard] = useState();
    const fetchVegRecipe = async () => {

  
      // const data =await r.text();
      const data = JSON.parse(vegetarianDishesJson);
      setVegRecipeCard(data);
    };
    ...
    // console.log(vegetarianDishesJson)
    return (
      <>
        ...
        <div className="immagine bg-no-repeat hover:transition hover:duration-300 hover:object-none hover:object-center contrast-[1.1] saturate-[1.4]">
          ...
          <div className=" rounded-t-3xl bg-white shadow-sm">
              ...
              <div className="pt-8 flex justify-between items-baseline">
                ...
                <p className="flex text-gray">
                  ...
                  <span className="font-light text-xs">
                    {vegRecipeCard.readyInMinutes} min
                  </span>
                </p>
              </div>
              ...
              <div className="flex justify-between text-dark-green">
                <div className="text-sm font-semibold">
                  <div className="mb-4 flex items-center">
                    ...
                    {/* <p>{vegRecipeCard.nutrition.nutrients[3].amount}g carbs</p> */}
                  </div>
                  ...
                  <div className="mb-4 flex items-center">
                    ...
                    {/* <p>{vegRecipeCard.nutrition.nutrients[0].amount} Kcal</p> */}
                  </div>
                </div>
                <div className="mb-8 text-sm font-semibold">
                  <div className="mb-4 flex items-center">
                    ...
                    {/* <p>{vegRecipeCard.nutrition.nutrients[9].amount}g proteins</p> */}
                  </div>
                  <div className="mb-4 flex items-center">
                    <div className="bg-gray-mid rounded-lg p-1 mr-2">
                      <Image
                    ...
                    {/* <p>{vegRecipeCard.nutrition.nutrients[1].amount}g fats</p> */}
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="px-4 md:px-8">
              ...
              {/* <ul>
                {vegRecipeCard.extendedIngredients.map((ingredient) => {
                  return (
                    <Ingredients
                      key={ingredient.id}
            ...
            <section className="">
              ...
              {/* <div>
                {vegRecipeCard.extendedIngredients.map((instruction, index = 0) => {
                  return (
                    <Instructions
                      key={instruction.id}
